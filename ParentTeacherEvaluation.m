...
@interface ParentTeacherEvaluation ()

@end

@implementation ParentTeacherEvaluation
...
- (void)rateView:(ParentTeacherEvaluation *)rateView ratingDidChange:(float)rating {
    self.statuslb.text = [NSString stringWithFormat:@"Rating: %f", rating];
}
